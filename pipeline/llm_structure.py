    ...
    try:
        ...
        if response.status_code == 200:
            ...
            try:
                ...
                # 기본 검증
                if isinstance(structured_problem, dict) and 'content_blocks' in structured_problem:
...
def main():
    """메인 함수"""
    print("LLM Structure Script 시작")
    total_start_time = time.time()

    # 파일 경로 설정
    input_file = "output/problems.json"
    output_file = "output/problems_llm_structured.json"
